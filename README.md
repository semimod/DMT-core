...
```
cd existing_repo
git remote add origin https://gitlab.com/dmt-development/dmt-core.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dmt-development/dmt-core/-/settings/integrations)
...
- M. Müller | Markus.Mueller3@tu-dresden.de
- M. Krattenmacher | Mario.Krattenmacher@tu-dresden.de
- P. Kuthe | jarodkuthe@protonmail.com

## License

This procject is licensed under GLP-v3-or-later
